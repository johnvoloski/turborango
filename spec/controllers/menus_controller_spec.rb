...
describe MenusController do
  ...
  let(:valid_attributes) { { "dish" => "MyText" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved menu as @menu" do
        ...
        post :create, {:menu => { "dish" => "invalid value" }}, valid_session
        assigns(:menu).should be_a_new(Menu)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested menu" do
        ...
        Menu.any_instance.should_receive(:update).with({ "dish" => "MyText" })
        put :update, {:id => menu.to_param, :menu => { "dish" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the menu as @menu" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Menu.any_instance.stub(:save).and_return(false)
        put :update, {:id => menu.to_param, :menu => { "dish" => "invalid value" }}, valid_session
        assigns(:menu).should eq(menu)
      end
